...
void controlMixer() {
  ...
  //Quad mixing for oneShot125 escs
  ...
  s1_command_scaled = thro_des - roll_PID ; //front right
  s2_command_scaled = thro_des + roll_PID ; //Front Left
  s3_command_scaled = thro_des + pitch_PID; //BACK
